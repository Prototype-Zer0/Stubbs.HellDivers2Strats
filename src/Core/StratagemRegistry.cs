    ...
    public static class StratagemRegistry
    {
        ...
        private static ImmutableDictionary<string, StratagemDefinition> BuildDefinitions()
        {
            ...
            foreach (var definition in new[]
            {
                ...
                CreateDefinition("NUX-223 Hellbomb", Keys.Down, Keys.Up, Keys.Left, Keys.Down, Keys.Up, Keys.Right, Keys.Down, Keys.Up),
                ...
                CreateDefinition("Reinforcement Pods", Keys.Left, Keys.Right, Keys.Up, Keys.Up, Keys.Up),
